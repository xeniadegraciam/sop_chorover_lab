...
- Centrifuge at **RCF = 23 600 g, for 10 minutes**. The centrifuge can fit just **6 vessels per time**, which means 2 samples (in triplicates). Refer to the rounds calculation tab to check how to organize the rounds of centrifuge.
...
- Store supernatant at 4 Celcius until analysis in ALEC.
- The solid residue  of each sample needs to be washed with DI water and stored at -45 Celcius, prior to solid phase characterization and spectroscopic analysis.
- Do the same with the samples that stayed rotating for 24 hours.
- Store the lung fluids in the fridge at 4 Celcius when not using them.
