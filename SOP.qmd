...
The folowing chart from USGS helps identify the different clays using the separation in Armstrong. You can download that chart on the following link. *(I recommend PDF format for more readability)*.
