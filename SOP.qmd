...
Equipment: [**Nicolet Magna-IR 560 Fourier Transform Infrared (FTIR)

Spectrometer**](https://choroverlab.arizona.edu/Equipment%20pages/FTIR_bench.html)
...
This technique applies a heat source that bounce the molecules inside your sample (teh red laser observed is not the source, it is just for guidance).
...
Some peaks of interest for ATR inyour sample: 
- Hydroxides are on 3400 cm-1
- Aluminum hydroxides are on 3600 cm-1
- Silica is from 1030 to 1100 cm-1


**FIRST THING: ON THE MACHINE, PRESS THE BUTTON BESIDE THE ATR ACCESORY UNTIL IT LIGHTS BLUE, MEANING THE ATR MODE IS ON.**

#### **Sample prep**

- There are 2 types of tip on the FTIR, one is concave for bigger grains like sand, the other is flat for clays and finer soils.
...
**Run a blank sample to check if looks entirely flat, that means that the background is being substracted correctly.**
...
-   File -\> Save As -\> Set Filename to Title (BLANK SAMPLE) -\> Save it (SPA, SPC, CSV)
