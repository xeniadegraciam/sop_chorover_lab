...
<img src="SOP_files/figures/logos/cales_logo.png" style="margin-bottom: 10px;" width="300"/>
...
*a gift for Rob, to give him some rest from repeating the same information every time someone joins the lab xD*
:::
...
-   In case you need access to the VPN, follow the next link to Download Install and LogIn to the VPN on your computer (this will just let you log in if you are outside campus, I don't think it let you log in if you are on-campus network). ![Remote Access Connection](SOP_files/figures/Slides_SOP/518vpn.PNG)
:::
