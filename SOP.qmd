...
- On "Alignment" section, find:
    - Source Control -> Start -> **Crossover** -> Uncheck the Limit voltage -> **Increase slowly until getting the same as image below, but never exceed 1.9**
...
- Wait until the **pressure decrease to 10^-4**, and the drawing in the computer turns green (meaning its vacuumed)
- **If you did EDS, switch back the COM port to "A: NPGS".**
