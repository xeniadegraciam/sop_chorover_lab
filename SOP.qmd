...
- If your samples are showing charge effect, then use gold coating. It also makes the quality of image better.
...
- On "Alignment" section, find:
    - Source Control -> Start -> Crossover (Uncheck the Limit voltage) -> **Increase until 1.9** (never go above 2)
...
- Zoom in with **+** and focus it using the **"Reduced Area"** focus.
