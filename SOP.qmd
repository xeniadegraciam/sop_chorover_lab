...
-   *Here I included my lab notes when working at Chorover's lab.*
...
-   *Warning: English is not my native language. My apologies for any language mistakes on these notes!*
:::
...
-   Find the Corundum (alpha-Al2O3) in the desiccator. Heat the Corundum in the oven for at least 1 hour at 550 Celsius. Let it refresh for 1 hour. Store the Corundum on the desiccator when all the work has finished.
-` If using toxic samples, prepare them in the fume hood.
...
-   Check the water level and the filler on the back of the lab. Fill them with super clean water, such as UV Reverse Osmosis water. Craig buys gallons of that treated water, ask him to repay that amopunt of water with your projects budget.
...
-   Them sample holder can take 15 samples per round of analyses.
...
<iframe 
  src="SOP_files/pdfjs/web/viewer.html?file=../XRD_SOP_XeniasEdits.pdf" 
  width="100%" 
  height="700px" 
...
<p>
If you can’t see the embedded PDF, 
<a href="SOP_files/XRD_SOP_XeniasEdits.pdf" target="_blank">click here to view or download the XRD SOP</a>.
</p>
...
<iframe 
  src="SOP_files/pdfjs/web/viewer.html?file=../Laser_PSA_Instructions_Mohaddese-XeniasEdits.pdf" 
  width="100%" 
  height="700px" 
  style="border: 1px solid #ccc;">
</iframe>
