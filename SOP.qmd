...
- Heat the fluids to 37 C
- Use centrifuge tubes.
- Use ALEC weight scale because that one has  the capacoty to measure 3 decimal figures.
- Add 0.002 grams of mass to 10 mL of lung fluid. Make triplicates of each sample, to achieve a 1:5000 solid to liquid ratio. (1 / 5000 = 0.002 factor)
...
- Centrifuge at 23 600 g. The centrifuge can fit just 6 vessels per time, which means 2 samples (in triplicates)
- Separate the supernatant solution.
- Using a syringe, filter the supernatant with 0.22 mm acid washed hydrophobic polypropylene GHP membranes (acro-disc, Pall Corp. PN 28139).
- Measure pH, EC, and dissolved oxygen?
- Acidified using 100 mL of HNO3 (63% v/v) or EDTA. Store at 4 C until analysis.
- Bring filtered supernatant to ALEC, to get it analyzed by ICP-MS for the elemental BAc concentrations.
- The solid residue  of each sample needs to be washed with DI water and lyophilized at −45 C and 0.013 kPa prior to solid phase characterization and spectroscopic analysis.
- Do the same with the samples that stayed in the incubator for 24 hours.
