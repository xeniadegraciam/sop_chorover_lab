...
- Log in to use the computer by scanning the QR code
- Open the N2 valve (parallel to hose = open)
...
- On "Alignment" section, find:
    ...
    - **Crossover**
    - Uncheck the Limit voltage -> **Increase slowly until getting the same as image below, but never exceed 1.9** This step takes around 2 minutes.


![Oval shape to get](SOP_files/figures/SEM_1.jpg){width="4in"}
   
    - Wait until the phrase "Limit Voltage" comes visible to click again.
    - If the filaments don't work (meaning you cant see anything), then modify contrast and brightness.
...
- You should see like **hexagon shape for the Gold** nano particles.
...
- Wait 10 minutes
- **Vent** (Wait to hear the "Dark Vader" opening sound)
- Open door
- Take samples out
