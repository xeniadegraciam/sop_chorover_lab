...
-   *Typos could possibly be found on these lab notes, as English is not my native language. If you do, please let me know to make the necessary corrections. Thanks!*
...
In order for the Andersen to work accurately as it was designed to work, the pump needs to be set up at **1 ACFM (28.3 liters/min)**.

![Extracted from Andersen Manual](SOP_files/figures/Andersen_PM_sizes.png)

The pump has to be ran at 1 ACFM (28.3 liters/min) always for the particle diameter range to work as the diagram.
...
- When starting the pump, do not connect the mini-columns yet until ALL the tubing has NO AIR inside, because ifnot you will fill your columns with air.
- Take the time of staring the flush of water.
- Take the flow ypu set up in the pump (1.5 mL/min)
