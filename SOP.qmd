...
::: callout-note
-   *Here are included some of my lab notes when working at Chorover's lab.*
...
Moved to this other repo due to its length: [Synchrotron repo](https://xeniadegraciam.github.io/sop_chorover_lab/Synchrotron.html)

Everything related Synchrotron is on the link above:

-   Data analysis
-   Beamline procedures

![Beamline 11-2 at Stanford Synchrotron Radiation Lightsource](SOP_files/figures/BL11-2.png){width="4in"}
...
Sign in to: [iLab](https://azcores.ilab.agilent.com/) to make reservations or check machine schedule. Look for ***CBC Keck Center for Nano-Scale Imaging***.

You can ask Rob to contact the **Research Support Services** to do this.

-   Brooke Beam Massani, Ph.D.
-   Staff Scientist
-   bbeam\@arizona.edu

All services should be acknowledged in publications and presentation as said in here: <https://cbc.arizona.edu/rss/acknowledging-rss-units>

![TB-B-Stage 6 of Andersen](SOP_files/figures/SEM_2_TB-B-St.6_with%20measur_Dec18.png){width="5in"}
...
::: callout-important
-   **Always plan for: 40 minutes extra. (Sample assembly = 20 min, Vent machine at start = 10 min, Vent machine in the end = 10 min)**
-   If your samples are showing charge effect, then use gold coating. No reservation needed, just walk-in users.
-   The SEM chamber can hold 6 samples, so divide your total number of samples by 6 to calculate how many rounds you need to do.
-   The Gold coating can hold 12 samples each round, and last for 20 days.
-   Sign the users book with your time at the end of SEM and Gold coating.
:::

**Gold Coating**

-   It takes 15 minutes.
-   The sample holder of that machine can get 12 samples inside, so you should divide your total samples number by 12 to get the rounds of gold coating you need to run.
-   The gold coating can last 20 days over your sample.
-   Sign the users book with your time at the end.

**Working station: Loading Samples in Sample Holder**

-   Load your samples to the sample holder (these procedure could take 30 minutes for 6 samples)
-   Make a mark in the tape to differentiate your samples from one another.
-   Remember the position of your samples, take pictures an dnotes if neccessary.

**SEM STARTING PROCESS**

-   Open the N2 valve, located behind the SEM machine, on the wall. (parallel to hose = open)
-   **Log in** to use the computer by scanning the **QR code** located at the machine table.

**Computer**

*XT microscope control software*

-   **Vent** -\> Yes (because I already opened the N2 valve)

![](SOP_files/figures/SEM_Vent.jpg){width="3in"}

-   Wait until the pressure increase to 10\^1, then it is safe to open.
-   Load the samples to the chamber.
-   Remember the position of your samples.
-   Measure the height of the samples, it must NOT exceed the height measured with the metallic tool.
-   Close the chamber and press it well.
-   **Pump**
-   Wait until the pressure decrease to 10\^-4, and the drawing in the computer turns green (meaning its vacuumed)

![](SOP_files/figures/SEM_Pump.jpg){width="2in"}

-   Setup:
    -   Spot: 3.0
    -   Voltage: 30 kV
    -   Map cross should be in the middle to get on top of the Gold standard
    -   Never cross the small circle with cross, just the big one.
-   **Beam On**
-   On "Alignment" section, find:

![](SOP_files/figures/SEM_Toolbar_Alignment.jpg)

-   Source Control -\> Start
-   **Crossover**
-   **AUTO** for it to find the oval image for itself
-   Uncheck the Limit voltage -\> **Increase slowly until getting the same as image below, but never exceed 2.5** This step takes around 2 minutes.
-   Wait until the phrase "Limit Voltage" comes visible to click again.

![Oval shape to get](SOP_files/figures/SEM_1.jpg){width="4in"}

-   If the filaments don't work (meaning you can't see anything), then modify contrast and brightness.
-   if it is super bright, we decrease the brightness.
-   **Check** "Limit Voltage"
-   Press **Finish**
-   Go back to main screen
-   Click on **Auto Contrast**

![](SOP_files/figures/SEM_Toolbar_AutoContrast.jpg)

**Gold reference**

-   Zoom in by clicking on **+** button, on the light-grey area of Gold.
-   Go to focus (press **"Reduced Area"** and right-click at the same time)

![](SOP_files/figures/SEM_ReducedArea.jpg){width="2in"}

-   You should see like **hexagon shape for the Gold** nano particles, magnification shoould be at 50,000X
-   When having the "Reduced Area" activated, you can use **"stigmation"** by using **shift and right-click** at the same time, slide up-to-down, or left-to-right.
-   After you found the gold hexagons, **Zoom out** all the way to find your sample (\~2mm scale).
-   Double click to move to your first sample.

**First sample**

-   Zoom in with **+** and focus it using the **"Reduced Area"** focus. NEVER use stigmation on a sample, its just allowed for the Gold standard reference.
-   Start measuring by going to the **graph section**.
-   Camera (to take the picture)

![](SOP_files/figures/SEM_Toolbar_Camera.jpg)

-   Press **F3** to activate contrast and brightness graphs, and change them by sliding the bar. (This can JUST be done when having the Camera photo activated)
-   Deactivate the graph mode by clicking F3 again.
-   Save As -\> **.tiff file**

***Take picture with no measurements first, then add your measurements and take the picture again***

-   Rule -\> Draw your measurements
-   Save Again with your measurements
-   Click on **Pause** button to deactivate the Camera mode.
-   Zoom out (\~2mm scale) to find your next sample.

**Next Sample**

-   Center the sample by having the cross in the center of the entire sample, using double-click.
-   Zoom in
-   Find a spot with multiple edges
-   Go to "Reduced Area" Focus again:
    -   Right click and move left or right to manage contrast.
    -   Left click outside the square to finish when you find crispy (high resolution).
-   Save As
-   When done, delete all the measurement notes you did
...
::: callout-important
-   Spectral Imaging takes 1 hour per sample.
-   Increasing the High Voltage and spot size to have a Death time between 20 to 50, could make your image blurry, so play with those (HV: 30 keV and Spot 5.0 worked well last time)
-   Make sure your energy on the x-axis is above 12 keV for Arsenic to be seen at 10.5 keV.
:::

-   Switch the **COM port to "B: EDS"**.
-   Open NSS software located at the second screen.
-   Select the type of microanalysis desired: I chose Spectral Imaging to get a map of all the elements on my sample.
-   Select the **elements of interest**. As we are interest in Arsenic, remember to check that the x-axis of your plot overpass 12 keV of energy as Arsenic is 10.5keV.
-   **Edit Acquisition Properties**
    -   Max keV = 40 keV
    -   Time Constant = Rate 3
-   On the **SEM software**
    -   increase the Spot to 5.0 (or until it makes the DT between 20 to 50, on NSS software, lower-right corner below the graph)
    -   maintain High Voltage on 30 keV
-   Acquire and Average Electron Image
-   Start Acquisition
-   At the end it will allow you to **Export to Power Point**.

**CLOSING PROCESS**

-   Zoom out (\~2mm scale)
-   Go back to the Gold center.
-   Alignments -\> Start -\> **Uncheck** the "Limit voltage"
-   Decrease the filament **"Limit Voltage" to 0.55**
-   When at 0.55, check again the "Limit Voltage"
-   Click in **"Finish"**
-   Beam Control -\> **Beam Off** (the drawing of column upper from that button should get empty)
-   Wait 10 minutes (in the meantime you can save your pictures in your **USB**)
-   **Vent** (Wait to hear the "Darth Vader" opening sound)

![](SOP_files/figures/SEM_DarthVader.jpg){width="2in"}

-   Open door
-   Take samples out
-   **Pump** again (we always want to leave it on vacuumed)
-   Wait until the **pressure decrease to 10\^-4**, and the drawing in the computer turns green (meaning its vacuumed)
-   **If you did EDS, switch back the COM port to "A: NPGS", and Spot to 3.0**
-   Close the **N2 gas valve**
-   Sign out from the app by clicking **"FINISH"**
-   Sign the **users book** with your time.
-   Clean samples out of the sample holder

::: callout-note
-   Never close the software on the computer when you are done.
:::
...
![](SOP_files/figures/FTIR.png){width="4in"}

::: callout-important
-   **FIRST THING: ON THE MACHINE, PRESS THE BUTTON BESIDE THE ATR ACCESSORY UNTIL IT LIGHTS ON BLUE, MEANING THE ATR MODE IS ON.**

-   ALWAYS check your **Background AGE** is showed in the lower-right end of the screen. This way you make sure that you are substracting the background when scanning your sample.
...
#### **OMNIC Computer Software**

-   Window -\> New Window

(*This step is in case there was someone working previously and left their work plotted there.*)

-   Check that the top of the window says **Experiment: iS50 ATR**

**EXPERIMENT SETUP**

-   Nothing has to be over the sample holder because you will measure the background first.
-   Close the sampler until you hear **2 clicks**.
-   Collect -\> Number of scans: 64 -\> **Collect Background after 120 minutes** -\> Save

![](SOP_files/figures/FTIR_ExpSetup.png){width="6in"}
...
(*humidity always looks the same: 3 peaks between 2800 to 2000*)

![Background look on FTIR-ATR](SOP_files/figures/FTIR_BackgroundLook.png){width="6in"}

::: callout-important
-   **Go again to Experimental Setup to CALL THE BACKGROUND you just measured**
...
-   The [RUFF database](https://rruff.geo.arizona.edu/AMS/amcsd.php) has FTIR and XRD data for you to compare and find out different minerals.
...
-   Downs, R.T. and Hall-Wallace, M. (2003) The American Mineralogist Crystal Structure Database. American Mineralogist 88, 247-250. [Link to paper](http://geo.arizona.edu/xtal/group/pdf/am88_247.pdf)

::: panel-tabset
## **Craig's Rasmussen Lab Computer procedure for powder X-ray Diffraction**

![](SOP_files/figures/XRD_machine.png){width="4in"}
...
![](SOP_files/figures/XRD_samples.png){width="5in"}
...
![](SOP_files/figures/XRD_water.png){width="3in"}
...
-   Butler, B. M., & Hillier, S. (2020). powdR: An R package for quantitative mineralogy using full pattern summation of X-ray powder diffraction data. Computers & Geosciences, 147, 104662. <https://doi.org/10.1016/j.cageo.2020.104662>

-   Chipera, S. J., & Bish, D. L. (2002). FULLPAT: a full-pattern quantitative analysis program for X-ray powder diffraction using measured and calculated patterns. Journal of Applied Crystallography, 35(6), 744–749. <https://doi.org/10.1107/s0021889802017405>

-   Chipera, S. J., & Bish, D. L. (2013). Fitting full X-Ray diffraction patterns for quantitative analysis: a method for readily quantifying crystalline and disordered phases. Advances in Materials Physics and Chemistry, 03(01), 47–53. <https://doi.org/10.4236/ampc.2013.31a007>
...
Remember to acknowledge the RSS (Research Support Services) in your publications.

Link to how to acknowledge them: <https://cbc.arizona.edu/rss/acknowledging-rss-units>

![Ground sample from the ball mill](SOP_files/figures/ball_mill.png){width="3in"}

![Sample holders ready for XRD analysis](SOP_files/figures/XRD_samples.png){width="4in"}
...
![Clay Chart](SOP_files/figures/clay_flow_usgs.gif){width="120%"}
...
::: {#fig-bl112 fig-align="center"}
![*Legend says (Rob) tapping this token fix the BET*](SOP_files/figures/BET_Token.png){width="2in"}
:::
...
![Drying station](SOP_files/figures/BET_Dessicator_NitrogenStation.png){width="4in"}
...
![BET machine](SOP_files/figures/BET.png){width="4in"}

[Back to top](#top)

## **Particle size distribution**

![LS-13-320 Laser Diffraction Particle Size Analyzer](SOP_files/figures/PSD_machine.png){width="4in"}
...
![HYPROP analysis](SOP_files/figures/HYPROP.png){width="6in"}
...
![WP4-C](SOP_files/figures/WP4C.png){width="6in"}
...
-   Pepper, I., Rensing, C., & Gerba, C. (2004). ENVIRONMENTAL MICROBIAL PROPERTIES AND PROCESSES. In Elsevier eBooks (pp. 263–280). <https://doi.org/10.1016/b978-012064477-3/50016-3>

-   Scientific, T. F. Andersen Sampler Impactor Manual - Six and Two Stage Viable Samplers Part Number 100072-00 29Oct2009.

::: callout-important
-   Bring your samples already sieved as close as you can to 10um. We have a 50 um and 20 um sieve.
-   This process must be done inside the hood. Use masks, googles, gloves and lab coat as particles could get into your body.
:::
...
But we also have the **Andersen Sampler Impactor** which give us a smaller and more classified range of particles.

![Andersen Sampler Impactor](SOP_files/figures/Andersen.png){width="4in"}
...
![Extracted from Andersen Manual](SOP_files/figures/Andersen_PM_sizes.png){width="6in"}
...
![Andersen Sample Impactor](SOP_files/figures/Andersen2.png){width="4in"}

![Examples of particles ran](SOP_files/figures/Andersen3.png){width="8in"}

After done with it, check the size of your particles with SEM to be sure they are correct. Bring your samples on your petri-dishes to the Chemistry Biochemistry Lab.

-   From this you can study the morphology of the grains to infer Mineralogy.
-   By doing Backscatter: Heavy elements are brighter than others, so you can differentiate them that way.

The following table is the result of the first ever **particle sizes observed on SEM**, after running the material **5 times**.
...
: *Andersen samples size seen with SEM*

### **Ramirez Lab Dust Generator**

The SOP of this machine is at Ramirez Lab, and it was created by Andreanna Roros, and revised by Zain.

These below are some notes specifically applied to my research projects:

-   The samples taken were sieved at the mine site to 2mm.
-   Sites like Iron King, with big sandy percentage, were left for 254 hours, instead of 4 hours like their protocol mentioned, to be able to break those big particles to more fine particle size, to be able to generate the required amount of dust for the analyses.

:::

## **Centrifuge**

![Samples on the Centrifuge rotor](SOP_files/figures/centrifuge.png){width="4in"}

::: callout-important
-   "CE" clears the centrifuge alarm, if it ever get activated.
...
![Balancing out the tubes on the rotor](SOP_files/figures/centrifuge_rotor_balance.gif){width="2in"}
...
![Centrifuge in 245](SOP_files/figures/centrifuge1.png){width="4in"}
...
Comparison of different simulated fluids used in literature:

Our research is focused on

-   **SELF** for Epithelium.

-   **ALF** for Alveolar Macrophage simulation - studying the release of arsenic by chelation effect by citrate.

-   **PSF** for Alveolar Macrophage simulation - studying the release of arsenic by dissolution of minerals due to low pH.

|                                                      | Guldberg et al. (1998) | Guldberg et al. (1998) | Stefaniak et al. (2005)      | Midander et al. (2007)        | Boisa et al. (2014) | Thomas et al. (2018) |
|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
| **Reagent (g/L)**                                    | **C: MK (phthalate)**  | **E: MG (HCl)**        | **"PSF"**                    | **"ALF"**                     | **"SELF"**          | **"SLF"**            |
| MgCl2 \* 6 H2O                                       | \-                     | 0.160                  | \-                           | \-                            | 0.200               | 0.219                |
| MgCl2                                                | \-                     | \-                     | \-                           | 0.0497                        | \-                  | \-                   |
| NaCl                                                 | 6.650                  | 6.171                  | 6.650                        | 3.210                         | 6.020               | 6.415                |
| NaOH                                                 | \-                     | \-                     | \-                           | 6.000                         | \-                  | \-                   |
| KCl                                                  | \-                     | 0.031                  | \-                           | \-                            | 0.298               | \-                   |
| CaCl2 \* 2 H2O                                       | 0.029                  | 0.060                  | 0.029                        | 0.128                         | 0.256               | 0.257                |
| NH4Cl                                                | 0.535                  | \-                     | \-                           | \-                            | \-                  | \-                   |
| Na2SO4 (anhydrous)                                   | 0.071                  | 0.080                  | 0.071                        | 0.039                         | 0.072               | 0.079                |
| Na2HPO4                                              | 0.171                  | 0.148                  | 0.142                        | 0.071                         | 0.150               | 0.150                |
| NaHCO3                                               | \-                     | 1.900                  | \-                           | \-                            | 2.700               | 2.706                |
| NaCH3CO2 \* 3 H2O                                    | 0.954                  | \-                     | \-                           | \-                            | \-                  | \-                   |
| Na2-tartrate \* 2 H2O                                | \-                     | 0.180                  | \-                           | 0.090                         | \-                  | 0.181                |
| Citric acid                                          | \-                     | \-                     | \-                           | 20.800                        | \-                  | \-                   |
| Na3-citrate \* 2 H2O                                 | 0.059                  | 0.152                  | \-                           | 0.077                         | \-                  | 0.154                |
| 90% lactic acid                                      | \-                     | 0.056                  | \-                           | \-                            | \-                  | \-                   |
| Na-lactate                                           | \-                     | \-                     | \-                           | 0.085                         | \-                  | 0.174                |
| Glycine (NH2CH2COOH)                                 | 0.450                  | 0.118                  | 0.450                        | 0.059                         | 0.376               | 0.118                |
| KH-phthalate                                         | 2.043                  | \-                     | 4.085                        | \-                            | \-                  | \-                   |
| Na-pyruvate                                          | \-                     | 0.172                  | \-                           | 0.086                         | \-                  | 0.177                |
| Benzalconium-Cl                                      | \-                     | \-                     | 50 ppm                       | \-                            | \-                  | \-                   |
| HCl                                                  | \-                     | 0.881                  | \-                           | \-                            | \-                  | \-                   |
| L-Cysteine (C3H7NO2S)                                | \-                     | \-                     | \-                           | \-                            | 0.122               | \-                   |
| DPPC (dipalmitoyl phosphatidyl choline) (C40H80NO8P) | \-                     | \-                     | \-                           | \-                            | 0.100               | \-                   |
| Ascorbic acid                                        | \-                     | \-                     | \-                           | \-                            | 0.018               | \-                   |
| Uric Acid                                            | \-                     | \-                     | \-                           | \-                            | 0.016               | \-                   |
| Glutathione                                          | \-                     | \-                     | \-                           | \-                            | 0.030               | \-                   |
| Albumin (Bovine Serum Albumine (BSA))                | \-                     | \-                     | \-                           | \-                            | 0.260               | \-                   |
| Mucin                                                | \-                     | \-                     | \-                           | \-                            | 0.500               | \-                   |
| pH                                                   |                        |                        | 4.5 (Adjusted using 1 M KOH) | 4.5 (Adjusted using 1 M NaOH) | 7.4                 | 7.4                  |

**References**

-   Kastury, F., et al. (2018). "Methodological factors influencing inhalation bioaccessibility of metal(loid)s in PM(2.5) using simulated lung fluid." Environ Pollut 241: 930–937.
-   Stefaniak, A. B., et al. (2005). "Characterization of phagolysosomal simulant fluid for study of beryllium aerosol particle dissolution." Toxicol In Vitro 19(1): 123–134.
-   Midander, K., Pan, J., Wallinder, I.O., Leygraf, C., 2007. Metal release from stainless steel particles in vitro-influence of particle size. J. Environ. Monit. 9, 74e81.
-   Zanoni, I., et al. (2022). "Dissolution Rate of Nanomaterials Determined by Ions and Particle Size under Lysosomal Conditions: Contributions to Standardization of Simulant Fluids and Analytical Methods." Chem Res Toxicol 35(6): 963–980.
-   Boisa, N., et al. (2014). "Development and application of an inhalation bioaccessibility method (IBM) for lead in the PM10 size fraction of soil." Environ Int 70: 132–142.
-   Thomas, A. N., et al. (2018). "Oxidative Weathering Decreases Bioaccessibility of Toxic Metal(loid)s in PM10 Emissions From Sulfide Mine Tailings." GeoHealth 2(4): 118–138.

### **Methodology**

- Prepare the respective lung fluids to simulate.
- Pre-heat the fluids to **37 C.** Store them in the fridge when finish.
- Use centrifuge tubes.
- Use **ALEC scale** because that one has  the capacoty to measure 3 decimal figures.
- Add **0.002 grams of mass to 10 mL of lung fluid**. Prepare triplicates of each sample, to achieve a 1:5000 solid to liquid ratio. (1 / 5000 = 0.002 factor)
- Wrap each vessel with aluminum foil to avoid photo-oxidation.
- Prepare 6 replicates per sample, because we need 3 for 1-hour incubation time, and other 3 for 24-hour incubation time.
- Rotate in Rotisserie inside the pre-heated incubator for 1 hour at **37 Celcius. Rotation of 60 rpm.**
- Take the 1 hour incubation samples to the centrifuge.
- Centrifuge at **23 600 g, for 10 minutes**. The centrifuge can fit just **6 vessels per time**, which means 2 samples (in triplicates). Refer to the rounds calculation tab to check how to organiz the rounds of centrifuge.
- Separate the supernatant solution.
- Using a syringe, filter the supernatant with **0.22 um** acid washed hydrophobic polypropylene GHP membranes (acro-disc, Pall Corp. PN 28139).
- Measure pH, EC, and dissolved oxygen?
- For ICP-MS: Acidify samples to preserve the arsenic speciation, by adding:
    - **500 uL of 0.250 M EDTA added to 10 mL sample (Fe conc < 500 mg/L) or**
    - 100 uL of 0.125 M EDTA added to 10 mL sample (Fe conc < 10 mg/L) **or**
    - 2% w/w HNO3
    - 100 uL of HNO3 (63% v/v) **or** 
- For Ion Chromatography: don't add any extra acid.
- For Iron Speciation: add HCl.
- Store supernatant at 4 C until analysis in ALEC.
- The solid residue  of each sample needs to be washed with DI water and stored at -45 C, prior to solid phase characterization and spectroscopic analysis.
- Do the same with the samples that stayed rotating for 24 hours.
- Store the lung fluids in the fridge at 4 C when not using them.
...
- 10mL pipette
- 10 mL pipette tips
- EDTA, HCl, HNO3 for conservation of species
- ALEC scale (for 3 decimal figures)
- weightboat
- Heater
- Centrifuge
- Incubator
...
- 3 fluids
- 3 replicates
- 2 time steps (1 hour and 24 hour)

Total: 126 vessels

***Centrifuge can fit just 6 vessels per round***

126 vessels / 6 = 21 rounds in centrifuge

**Centrifuge rounds**

Round 1 (SELF)

- IK-B-PM10-SELF-1hr-1
- IK-B-PM10-SELF-1hr-2
- IK-B-PM10-SELF-1hr-3
- IK-B-PM2.5-SELF-1hr-1
- IK-B-PM2.5-SELF-1hr-2
- IK-B-PM2.5-SELF-1hr-3
...
- IK-B-PM10-ALF-1hr-2
- IK-B-PM10-ALF-1hr-3
- IK-B-PM2.5-ALF-1hr-1
- IK-B-PM2.5-ALF-1hr-2
- IK-B-PM2.5-ALF-1hr-3
...
- IK-B-PM10-PSF-1hr-2
- IK-B-PM10-PSF-1hr-3
- IK-B-PM2.5-PSF-1hr-1
- IK-B-PM2.5-PSF-1hr-2
- IK-B-PM2.5-PSF-1hr-3

Round 4 (SELF)

- MG-B-PM10-SELF-1hr-1
- MG-B-PM10-SELF-1hr-2
- MG-B-PM10-SELF-1hr-3
- MG-B-PM2.5-SELF-1hr-1
- MG-B-PM2.5-SELF-1hr-2
- MG-B-PM2.5-SELF-1hr-3
...
- MG-B-PM10-ALF-1hr-2
- MG-B-PM10-ALF-1hr-3
- MG-B-PM2.5-ALF-1hr-1
- MG-B-PM2.5-ALF-1hr-2
- MG-B-PM2.5-ALF-1hr-3
...
- MG-B-PM10-PSF-1hr-2
- MG-B-PM10-PSF-1hr-3
- MG-B-PM2.5-PSF-1hr-1
- MG-B-PM2.5-PSF-1hr-2
- MG-B-PM2.5-PSF-1hr-3

**And so on... until it is time for the 24-hour samples.**
...
![Jars ready for Freeze-Dryer](SOP_files/figures/Freeze-Dryer.png){width="4in"}
...
## **Flow-through reactive mini-column experiment**

![Setup for mini-column experiments](SOP_files/figures/mini-columns.png){width="6in"}
...
![Metal-Free Tubes](SOP_files/figures/metal-free-tubes.png){width="6in"}

![Luer lock sizes](SOP_files/figures/luer-lock.png){width="3in"}
...
![SSE](SOP_files/figures/Slides_SOP/SSE.png){width="120%"}
...
::: panel-tabset
## **Sample volume required by analyses:**
...
-   Use Teflon vessels (CEM Xpress)
-   Start acid digestion at a fume hood.
-   Use a ratio of **3:1** of Aristar Plus quality **nitric acid (HNO3)** and **hydrofluoric acid (HF)** (i.e., 1.5 mL HNO3 and 0.5 mL HF)
-   Microwave samples at **180 ᵒC** for 9.5 minutes.
-   Add 2.5 mL **boric acid (8% H2BO4)**
-   Heat samples again at **170 ᵒC** for neutralization
-   After high pressure and high temperature digestion,
-   Allow the vessels to cool for 5 minutes before removing them from the microwave
-   uncapping and venting each vessel in a fume hood.\
-   If the digested sample contains particulates which may clog nebulizers or interfere with injection of the sample into the instrument, the sample may be centrifuged, allowed to settle, or filtered.
-   Proceed with ICP-MS in collision mode to inhibit isobaric interference.
...
![ICP-MS](SOP_files/figures/ICP-MS.png){width="4in"}
...
![](SOP_files/figures/UHP_Nitric_Acid.png){width="2in"}
...
![](SOP_files/figures/Spectrophotometer.png){width="4in"}
...
-   Wavelength filter for Iron should be **562 nm**.
    -   Buy it here: [ThermoFisher](https://www.thermofisher.com/order/catalog/product/1425605)
...
Use the following link to find out how to fill up the building number of the place you are requesting the pick up to be done:

<https://map.arizona.edu/>

## **Printing Posters**

These are two places you can print posters on campus. Sometimes on the website, they also show the prices.

***My preferred is the first one because they print in 24 hours.***

**BioCommunications**

<https://biocom.arizona.edu/service-type/posters/service/poster-printing>

Located North Campus, close to the Banner Hospital.

Use the "paper" option, it refers to Photo Paper.

**FastCopy in the Student Union**

<https://union.arizona.edu/fastcopy/>

Products and Services -\> Posters (Wide Format)).

They accept project account numbers, so you do not need to do the reimbursement.
...
![Remote Access Connection](SOP_files/figures/Slides_SOP/518vpn.png){width="6in"}

[Back to top](#top)

## **ENVS Business Office**

![ENVS](SOP_files/figures/logos/ENVS_logo.png){width="4in"}

<https://envs.arizona.edu/about/contact/business-office>
...
-   Thomas, A. N., Root, R. A., Lantz, R. C., Saez, A. E. & Chorover, J. Oxidative weathering decreases bioaccessibility of toxic metal(loid)s in PM10 emissions from sulfide mine tailings. Geohealth 2, 118-138 (2018). [https://doi.org:10.1002/2017GH000118](https://doi.org:10.1002/2017GH000118){.uri}
...
## **Boyoungb's suggestions**

### KdD Partition Coefficients

-   Geochemical Earth Reference Model (GERM) -- Home page. (n.d.). <https://earthref.org/GERM/#gsc.tab=0>
