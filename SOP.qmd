...
<iframe src="SOP_files/pdfjs/web/viewer.html?file=../XRD_SOP_XeniasEdits.pdf" width="100%" height="700px" style="border: 1px solid #ccc;">

::: {style="text-align: center;"}
<embed src="SOP_files/XRD_SOP_XeniasEdits.pdf" width="100%" height="700px" type="application/pdf">
:::


If you can’t see the embedded PDF, 📎 [click here to view or download the XRD SOP.](SOP_files/XRD_SOP_XeniasEdits.pdf)
...
<iframe src="SOP_files/pdfjs/web/viewer.html?file=../Laser_PSA_Instructions_Mohaddese-XeniasEdits.pdf" width="100%" height="700px" style="border: 1px solid #ccc;">

</iframe>

<p>If you can’t see the embedded PDF, <a href="SOP_files/Laser_PSA_Instructions_Mohaddese-XeniasEdits.pdf" target="_blank">click here to view or download the Laser PSA Instructions</a>.</p>
