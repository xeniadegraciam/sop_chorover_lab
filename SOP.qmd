...
***Always plan for 30 minutes extra of your data analysis, for initiation on the machine (15 minutes process) and finalization of the machine (15 minutes process)***

**STARTING PROCESS**

- Load your samples to the porta-sample
- Log in to use the computer by scanning the QR code
- Open the N2 valve (parallel to hose is open)
- **Vent** -> Yes (because I already opened the N2 valve)
- Wait until the pressure increase to E10^1, then it is safe to open.
...
- **Pump**
- Wait until the pressure decrease to E-4, and the drawing in the computer turns green.
...
- Setup:
    - Spot: 3.0
    - Voltage: 30 kV
    - Map cross should be in the middle

- **Beam On**
- On "Alignment" section, find:
    - Save Control -> Start -> Crossover (Uncheck the filament voltage) -> Increase until 1.9 (never go above 2)
    - Wait until the phrase "Limit Voltage" comes visible to click again.
    - If the filaments dont works (meaning you cant see anything), then modify contrast and brightness.
    - if it is super bright, we decrease the brightness.
- Check "Limit Voltage"
- Press Finish
- Go back to main screen
- Click on Auto Contrast
- Go to focus (press three? and right-click at the same time)
- Use "stigmation" by using shift and right-click at the same time
- Zoom out all the way to find your sample.
- Double click to move?
- Click on the graph section.
- Rule -> Draw
- Camera

***If your samples are showing charges effect, then go for gold coating. It also makes the quality of image better.***

- Press F3 to manage contrast and brightness.
- Save As -> **.tiff file**
- Zoom out to find your next sample.
- Center the cross
- Zoom in
- Go to Focus again:
    - Find a spot wth multiple edges
    - Right click and move left or right to manage contrast.
    - Left click outside to finish when you find crispy (high resolution).
    
***Take picture with no note first, then add your measurement notes and take the picture again***

- Delete all the measurement notes you did

**CLOSING PROCESS**

- Go back to the center.
- Alignments -> Start -> Uncheck the limit voltage -> Decrease the filament Voltage to 0.55
- When at 0.55, check again the "Limit Voltage"
- Beam Control -> **Beam Off**
- Wait 10 minutes
- Vent -> Open door
- Take sample out
- Pump again (we always want to leave it depressurized)
- Wait until you hear the sound and open the door
- Clean samples out of the porta-sample
