...
author:
  - name: "Xenia De Gracia Medina"
    #affiliation: "Department of Environmental Sciences, University of Arizona"
    email: "xeniadegracia@arizona.edu"
    corresponding: true
  - name: "Rob Root"
    #affiliation: "Department of Environmental Sciences, University of Arizona"
    email: rroot@arizona.edu
date: last-modified
format:
  html:
    ...
    theme:
      light: cosmo
      dark: darkly
    lightbox: auto   # enables built-in gallery support
    fontsize: 1.3em
...
::: callout-note
-   *Here are included some notes taken when working at the beamlines of Stanford Synchrotron Radiation Lightsource, and also about how to use the data analysis softwares Athena, LARCH and SIXPACK, hoping it can help as a guide for future students at Chorover Lab when performing this kind of analyses*
...
[SOP repo](https://xeniadegraciam.github.io/sop_chorover_lab/SOP.html)
...
![Fitting results](Synchrotron_files/figures/sixpack_deadtime.png){width="6in"}

![Deadtime correction](Synchrotron_files/figures/sixpack_deadtime2.png){width="6in"}
...
::: callout-note
*Some of the hundreds of XAS references that Dr. Rob Root has collected during his numerous trips to the synchrotrons around the world.*
:::
...
:::{.html}
<iframe 
  src="Synchrotron_files/figures/RobRefs_As_XANES.html" 
  width="100%" 
  height="900px" 
...
:::{.html}
<iframe 
  src="Synchrotron_files/figures/RobRefs_Fe_XANES.html" 
  width="100%" 
  height="900px" 
  style="border:none; overflow:auto;">
</iframe>
...
:::{.html}
<iframe 
  src="Synchrotron_files/figures/RobRefs_S_XANES.html" 
  width="100%" 
  height="900px" 
  style="border:none; overflow:auto;">
</iframe>
...
![BL 11-2](Synchrotron_files/figures/BL11-2/BL11-2.png){width="4in"}
...
![gold standard](Synchrotron_files/figures/BL11-2/I2_references.png){width="4in"}
...
![MONO tuning](Synchrotron_files/figures/BL11-2/interface_MONO_tuning.png){width="4in"}
...
![interface: channel](Synchrotron_files/figures/BL11-2/interface_channels.png){width="3in"}
...
![Harmonics](Synchrotron_files/figures/BL11-2/harmonics_detuning.png)

#### **ALLIGNMENT**

***Sample position centered on the sample holder window. We scan all the holder and select the center of each window.***

![Scan Motor](Synchrotron_files/figures/BL11-2/interface_ScanMotor.png){width="6in"}
...
![VERT_ADC](Synchrotron_files/figures/BL11-2/interface_Vert_ADC.png){width="7in"}
...
![detector_cover](Synchrotron_files/figures/BL11-2/detector_cover_caution.png){width="4in"}
...
![interface: detector](Synchrotron_files/figures/BL11-2/interface_detector.png){width="9in"}
...
![interface: gains/offset](Synchrotron_files/figures/BL11-2/interface_gains_offset.png){width="5in"}

![interface: channels](Synchrotron_files/figures/BL11-2/interface_channels.png){width="4in"}
...
![interface: Queue](Synchrotron_files/figures/BL11-2/interface_queue.png)
...
![Synchrotron book example](Synchrotron_files/figures/BL11-2/notes.png){width="6in"}
...
![LN2_fill_station](Synchrotron_files/figures/BL11-2/LN2_fill_station.png){width="4in"}
...
![pump](Synchrotron_files/figures/BL11-2/pump.png){width="4in"}
...
![pump hose](Synchrotron_files/figures/BL11-2/pump_connection.png){width="4in"}

-   Take out the cryostat. **Unscrew** it and place those screws in a known place. DO NOT loose them.

![used cryo sample holder](Synchrotron_files/figures/BL11-2/cryo_sample_holder.png){width="4in"}

-   Take the **new cryostat** and put it on position. Screw it on 2 corners.

![new cryo screwed](Synchrotron_files/figures/BL11-2/cryo_screw.png){width="4in"}
...
![LN2_for_detector](Synchrotron_files/figures/BL11-2/LN2_for_detector.png){width="4in"}
...
![XAS for SSRL](Synchrotron_files/figures/Synchrotron_samples_XAS_SSRL.png){width="4in"}

![XRD for BNL](Synchrotron_files/figures/Synchrotron_samples_XRD_BNL.png){width="4in"}

![XRD for BNL](Synchrotron_files/figures/Synchrotron_samples_XRD_SSRL.png){width="4in"}

![XRD for BNL](Synchrotron_files/figures/Synchrotron_samples_XRD_SSRL2.png){width="4in"}
